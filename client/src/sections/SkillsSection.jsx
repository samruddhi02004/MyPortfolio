...
import { skillsCategories, skillsContent } from "../constants/skillsData.js";
...
const skills = [
  { name: "Python", level: 90, category: "analytics", icon: "python" },
  { name: "SQL", level: 88, category: "analytics", icon: "sql" },
  { name: "Power BI / Tableau", level: 84, category: "analytics", icon: "mysql" },
  { name: "Machine Learning", level: 85, category: "aiml", icon: "python" },
  { name: "Data Visualization", level: 86, category: "aiml", icon: "graphql" },
  { name: "React.js", level: 88, category: "development", icon: "react" },
  { name: "Node.js (Basic)", level: 72, category: "development", icon: "nodejs" },
...
const categories = [
  ...
  { id: "analytics", label: "Data Analytics", color: "bg-gradient-to-r from-blue-500 to-cyan-500" },
  { id: "aiml", label: "AI / ML", color: "bg-gradient-to-r from-green-500 to-emerald-500" },
  { id: "development", label: "Development", color: "bg-gradient-to-r from-violet-500 to-fuchsia-500" },
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Core technologies I use for analytics, AI/ML, and full-stack development
          </p>
        </motion.div>
