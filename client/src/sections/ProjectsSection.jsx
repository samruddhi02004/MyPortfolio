...
const categoryColors = {
  ...
  "Web Development": "from-blue-500/20 to-cyan-600/20 text-blue-600 border-blue-500/30",
  "Artificial Intelligence": "from-amber-500/20 to-orange-600/20 text-amber-600 border-amber-500/30"
};

const fallbackCategoryColor = "from-primary/20 to-purple-600/20 text-primary border-primary/30";
const fallbackAccentColor = "from-primary to-purple-600";
                ...
                <div className="relative bg-background border border-border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 h-full flex flex-col">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium backdrop-blur-sm border ${getCategoryColor(project.category)}`}>
                        {project.category}
                      </span>
                    </div>
                  ...
                  {/* Accent Border */}
                  <div className={`h-1 bg-gradient-to-r ${project.accentColor ?? fallbackAccentColor}`} />
                </div>
              </motion.div>
            ))}
          </AnimatePresence>
