...
import { footerContent } from "../../constants/navigationData.js";

export const Footer = () => {
  const currentYear = new Date().getFullYear();
  
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://linkedin.com/in/samruddhi-gaikwad-71042a28a", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://www.instagram.com/samrruddhi_?igsh=c256dzQwdzlnNHBx", label: "Instagram" },
    { icon: <Github size={18} />, href: "https://github.com/samruddhi02004", label: "GitHub" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">SAMRUDDHI GAIKWAD</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                B.Tech IT student focused on Data Analytics, AI/ML, and Full Stack Development.
              </p>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Subscribe for updates on my latest analytics, AI, and development projects.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Samruddhi Gaikwad. All rights reserved.</p>
            </div>
